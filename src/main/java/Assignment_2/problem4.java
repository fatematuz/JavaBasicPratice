/* write a programme 1 piece sharee 3500 tk, 2 piece shirt 2000 tk and 1 piece pant 750 tk. Find total price
and total quantity using regular expression.*/
...
public class problem4 {
    public static void main(String[] args) {
        ...
        System.out.println("==================" );
        System.out.println("The total quantity: "+totalQuantity);
